...
class Rahil_bill_sys:
    def __init__(self,root):
        ...
        lbl_color = 'white'
        #Title of App
        title = Label(self.root,text = "Billing System",bd = 12,relief = GROOVE,fg = fg_color,bg = bg_color,font=("times new roman",30,"bold"),pady = 3).pack(fill = X)
        ...
        #========Hotdog
        hair_lbl = Label(F2,font = ("times new roman",15,"bold"),fg = lbl_color,bg = bg_color,text = "VadaPav")
        ...
        #===========Frame Content
        maza_lbl = Label(F2,font = ("times new roman",15,"bold"),fg = lbl_color,bg = bg_color,text = "Coca-Cola")
        ...
        #===================Bill Aera================#
        F3 = Label(self.root,bd = 10,relief = GROOVE,bg="blue")
        F3.place(x = 960,y = 180,width = 325,height = 380)
        #===========
        bill_title = Label(F3,text = "Bill List",font = ("times new roman",12,"bold"),bd= 7,relief = GROOVE,bg="red")
